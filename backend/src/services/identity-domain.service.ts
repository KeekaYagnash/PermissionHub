...
export const developmentUsers:DirectoryUser[]=[
 {id:'user_org_admin_dev',email:'org.admin@disraptor.example',displayName:'Organisation Admin',providerSubject:'dev-org-admin',memberships:[membership('membership_org_admin', 'ORGANISATION_ADMIN',[scope('TENANT',tenant.id,{canRequest:true,canManageConfiguration:true})])]},
