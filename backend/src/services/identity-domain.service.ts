...
export const developmentAccounts:AwsAccountContext[]=[
 {id:'account_prod_payments_dev',tenantId:tenant.id,organisationId:organisation.id,ouId:developmentOus[0]!.id,accountId:'111122223334',accountName:'Production Payments',accountType:'PRODUCTION',environment:'production',riskTier:'HIGH',region:'af-south-1',connectionType:'ASSUME_ROLE',connectionStatus:'DISCONNECTED',readRoleArn:'arn:aws:iam::111122223334:role/PermissionHubReadRole',provisionRoleArn:'arn:aws:iam::111122223334:role/PermissionHubProvisionRole'},
 {id:'account_sandbox_dev',tenantId:tenant.id,organisationId:organisation.id,ouId:developmentOus[1]!.id,accountId:'111122223335',accountName:'Development Sandbox',accountType:'DEVELOPMENT',environment:'development',riskTier:'LOW',region:'af-south-1',connectionType:'DEFAULT_CHAIN',connectionStatus:'CONNECTED'},
 {id:'account_security_dev',tenantId:tenant.id,organisationId:organisation.id,ouId:developmentOus[2]!.id,accountId:'111122223336',accountName:'Security Tooling',accountType:'SECURITY',environment:'security',riskTier:'CRITICAL',region:'af-south-1',connectionType:'ASSUME_ROLE',connectionStatus:'DISCONNECTED',readRoleArn:'arn:aws:iam::111122223336:role/PermissionHubReadRole',provisionRoleArn:'arn:aws:iam::111122223336:role/PermissionHubProvisionRole'}
];
