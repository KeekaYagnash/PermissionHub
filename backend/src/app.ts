...
app.get('/api/v1/health',(_req,res)=>res.json({status:'ok',version:'2.0.0',timestamp:new Date().toISOString(),provisioningMode:env.AWS_PROVISIONING_MODE,liveProvisioningEnabled}));
app.get('/api/health',(_req,res)=>res.json({status:'ok',version:'2.0.0',timestamp:new Date().toISOString(),provisioningMode:env.AWS_PROVISIONING_MODE,liveProvisioningEnabled}));
